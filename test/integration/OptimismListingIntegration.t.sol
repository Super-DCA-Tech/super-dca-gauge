...
contract OptimismListingIntegration is OptimismIntegrationBase {
  ...
  function testFork_ListToken_Success() public {
    ...
    assertEq(
      IERC721(POSITION_MANAGER_V4).ownerOf(nftId), address(listing), "Listing should own NFT"
    );
  }
  ...
  function testFork_ListToken_IncorrectHook() public {
    ...
    uint256 nftId =
      _createFullRangePosition(wrongKey, POSITION_AMOUNT0, POSITION_AMOUNT1, address(this));
  ...
  function testFork_ListToken_AlreadyListed() public {
    ...
    uint256 nftId1 =
      _createFullRangePosition(key, POSITION_AMOUNT0, POSITION_AMOUNT1, address(this));
  ...
  function testFork_MultipleTokenListings() public {
    ...
    uint256 wethNftId =
      _createFullRangePosition(wethKey, POSITION_AMOUNT0, POSITION_AMOUNT1, address(this));
    ...
    mockToken.mint(address(this), 10_000e18);
