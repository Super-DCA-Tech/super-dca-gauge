...
abstract contract DeployGaugeBase is Script {
  ...
  uint160 public constant INITIAL_SQRT_PRICE_X96_USDC =
    101_521_246_766_866_706_223_754_711_356_428_849; // SQRT_PRICE_1_2 (0.5 USDC/DCA)
  uint160 public constant INITIAL_SQRT_PRICE_X96_WETH = 5_174_885_917_930_467_233_270_080_641_214; // 0.0002344
  // ETH/DCA
  ...
  function run() public virtual returns (DeployedContracts memory) {
    ...
    uint160 flags = uint160(
      Hooks.BEFORE_INITIALIZE_FLAG | Hooks.BEFORE_ADD_LIQUIDITY_FLAG
        | Hooks.BEFORE_REMOVE_LIQUIDITY_FLAG | Hooks.BEFORE_SWAP_FLAG | Hooks.AFTER_INITIALIZE_FLAG
    );
    ...
    // Deploy staking (owned by deployer) and listing (admin = deployer, expected hook = deployed
    // hook)
